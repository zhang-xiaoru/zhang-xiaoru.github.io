...
I am in my final year at Xi'an Jiaotong University, majoring in Honors Program in physics. I have received an avaerage GPA of 3.9/4.0 in physics major courses (Top 5%). My transcript at XJTU is available [here](https://zhang-xiaoru.github.io/files/transcript_XJTU.pdf). 
...
One imnportatnt application of CVB is mode-devision multiplexing (MDM), where multiple orthogonal CVB modes are used as information carriers. Thus, demultiplexing of multi-mode CVB has become an interesting topic. When the spinning obejct is illuminate by a multi-mode vectro beam, the beating signle in the collecte intensity
